...
<div class="container" data-aos="fade-right">
    <h1><i class="fa-brands fa-windows"></i> Active Directory Kerberos Login</h1>
    <a href="https://rangesh-pt6115:8443/Zoho_Social/sso-auth"><button>OneTap SignOn</button></a>
    <form action="SSOAdloginuser" method="post">
